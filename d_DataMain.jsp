    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <div class="img"><img src="images/img1.jpg" width="180" height="336" alt="" class="fl" /></div>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="d_Upload.jsp">Upload Patient Report </a></li>
            <li><a href="d_Update.jsp">Update Patient Report </a></li>
            <li><a href="d_Delete.jsp">Delete Patient Report </a></li>
            <li><a href="d_ViewFiles.jsp">View All Patient Reports </a></li>
