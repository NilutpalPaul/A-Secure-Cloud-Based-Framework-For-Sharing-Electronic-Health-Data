          ...
          <div class="article">
            ...
            <table width="452" border="1.5" cellpadding="0" cellspacing="0" align="center">
              <tr>
                ...
                <td width="168" bgcolor="#FF0000"><div align="center" class="style25">Owner</div></td>
...
try 
	{
			...
			while ( rs.next() )
			{
              ...
              <tr>
                ...
                <td><div align="center" class="style27"><a href="p_FilesDetails.jsp?fname=<%=s2%>">View More ...</a></div></td>
                <%
