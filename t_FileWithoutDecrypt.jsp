...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html" class="style1">A Secure Privacy Preserving Cloud-based Framework for Sharing Electronic Health Data<br />
        </a></h1>
      </div>
 ...
 <ul>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Files Without Decrypt Permission : </span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <div class="article">
            <p align="justify">&nbsp;</p>
            <table width="642" border="1.5" cellpadding="0" cellspacing="0" align="center">
              <tr>
                ...
                <td width="112" bgcolor="#FF0000"><div align="center" class="style25">Data Provider </div></td>
