...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Files With Private Key : </span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <div class="article">
            <p align="justify">&nbsp;</p>
            <table width="642" border="1.5" cellpadding="0" cellspacing="0" align="center">
              <tr>
                ...
                <td width="169" bgcolor="#FF0000"><div align="center" class="style21"><strong>Private Key </strong></div></td>
                <%	  
	...
	int i=0,j=0,k=0;
      	...
      	try 
	{
        	String str="Generate Key";
      		String query="select * from request where privatekey!='"+str+"'"; 
