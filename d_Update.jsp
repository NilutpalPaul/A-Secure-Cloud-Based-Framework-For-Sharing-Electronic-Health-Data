  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        ...
        <table width="579" border="1.5" cellspacing="0" cellpadding="0" align="center">
          <tr>
            <td width="86" height="30" bgcolor="#FF0000"><div align="center" class="style21 style24"><strong>User ID </strong></div></td>
            <td width="168" bgcolor="#FF0000"><div align="center" class="style25">File Name </div></td>
            <td width="176" bgcolor="#FF0000"><div align="center" class="style25">Data Owner </div></td>
            <td width="176" bgcolor="#FF0000"><div align="center" class="style25">Date &amp; Time </div></td>
            <td width="176" bgcolor="#FF0000"><div align="center" class="style25">Update</div></td>
            <%	  
...
try 
	{
			...
			while ( rs.next() )
			{
					...
					application.setAttribute("fname",s2);	
					%>
          </tr>
          <tr>
            ...
            <td><div align="center" class="style27"><a href="d_Update1.jsp?usid=<%=i%>"><%=s2%></a></div></td>
            <%					
