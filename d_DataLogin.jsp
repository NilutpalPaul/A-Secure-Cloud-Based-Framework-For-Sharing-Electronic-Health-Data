    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <form action="d_DataAuthentication.jsp" method="post" id="leavereply">
            ...
            <p><span class="style4">New  Data Provider? click here to <a href="d_DataRegister.jsp"> Register</a></span></p>
          </form>
        </div>
      </div>
      <div class="sidebar">
