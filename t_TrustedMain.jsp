...
<head>
<title>Certificate AuthorityMain</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Welcome Certificate Authority: </span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <div class="img"><img src="images/img1.jpg" width="191" height="336" alt="" class="fl" /></div>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="t_GeneratePK.jsp"> PrivateKey Permission </a></li>
			 <li><a href="t_DecryptPer.jsp">Give Decrypt Permission </a></li>
            <li><a href="t_FileWithDecrypt.jsp">Files With Decrypt Permisson </a></li>
            <li><a href="t_FileWithoutDecrypt.jsp">Files Without Decrypt Permisson </a></li>
