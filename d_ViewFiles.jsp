...
try 
	{
			...
			while ( rs.next() )
			{
              ...
              <tr>
                ...
                <td><div align="center" class="style26"><a href="d_FilesDetails.jsp?fname=<%=s2%>">View More ...</a></div></td>
                <%
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="d_Upload.jsp">Upload File </a></li>
            <li><a href="d_Update.jsp">Update File </a></li>
            <li><a href="d_Delete.jsp">Delete File </a></li>
