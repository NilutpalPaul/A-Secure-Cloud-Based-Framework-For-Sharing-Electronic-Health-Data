...
<head>
<title>Certificate AuthorityLogin</title>
...
<div class="main">
    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="t_TrustedLogin.jsp"><span>Certificate Authority</span></a></li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Certificate AuthorityLogin : </span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <form action="t_TrustedAuthentication.jsp" method="post" id="leavereply">
            <label for="name"><br />
              Name (required)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </label>
            <input name="Data Userid" type="text" class="box" id="name" value="" />
            <label for="email"><br />
            <br />
              Password (required)&nbsp;&nbsp;
            </label>
