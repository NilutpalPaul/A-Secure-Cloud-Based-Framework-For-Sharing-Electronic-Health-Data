...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span> Key Response : </span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <div class="article">
            <form id="form" name="form1" method="post" action="u_findsk.jsp">
              <div align="center" class="style19">
                <p><br />
                  <span class="style20">Enter Report Name :
                  <input required="required" name="t14" type="text" size="30" />
                </span>        </p>
                <p><br />
                  <br />
                  <input type="submit" name="Submit" value="View Key Permission" />
                </p>
                <p>&nbsp; </p>
              </div>
